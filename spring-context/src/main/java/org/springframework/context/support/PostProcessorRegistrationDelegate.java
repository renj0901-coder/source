...
final class PostProcessorRegistrationDelegate {
	...
	public static void invokeBeanFactoryPostProcessors(
		...
		if (beanFactory instanceof BeanDefinitionRegistry) {
			...
			for (String ppName : postProcessorNames) {
				// 看是否实现了PriorityOrdered接口
				if (beanFactory.isTypeMatch(ppName, PriorityOrdered.class)) {
					// 创建BeanDefinitionRegistryPostProcessor对象
			...
			// 执行那些没有实现了PriorityOrdered或Ordered接口的普通BeanDefinitionRegistryPostProcessor的postProcessBeanDefinitionRegistry()方法
			...
			while (reiterate) {
				// 循环去拿BeanDefinitionRegistryPostProcessor，防止嵌套注册的BeanDefinitionRegistryPostProcessor
				reiterate = false;
				postProcessorNames = beanFactory.getBeanNamesForType(BeanDefinitionRegistryPostProcessor.class, true, false);
				for (String ppName : postProcessorNames) {
	...
	public static void  registerBeanPostProcessors(
		...
		// 升序排序
		sortPostProcessors(priorityOrderedPostProcessors, beanFactory);
		// 把升序排序的BeanPostProcessor注册到BeanFactory中beanPostProcessors
	...
	private static void invokeBeanDefinitionRegistryPostProcessors(
		...
		for (BeanDefinitionRegistryPostProcessor postProcessor : postProcessors) {
			...
			// postProcessBeanDefRegistry表示BeanDefinitionRegistryPostProcessor
